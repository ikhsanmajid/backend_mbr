/*
  ...
  - A unique constraint covering the columns `[nomorUrut,tahun]` on the table `nomormbr` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `nomormbr_nomorUrut_tahun_key` ON `nomormbr`(`nomorUrut`, `tahun`);
