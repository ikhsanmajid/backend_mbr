/*
  ...
  - Added the required column `jumlah` to the `detailpermintaanmbr` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `detailpermintaanmbr` ADD COLUMN `jumlah` INTEGER NOT NULL;
