...
async function add_department_employment(req, res, next) {
    try {
        let postData = {
...
async function find_department_employment(req, res, next) {
    try {
        const getData = {
...
async function detail_department_employment(req, res, next) {
    try {
        const paramData = {
...
async function find_bagian_department_employment(req, res, next) {
    try {
        let getData = {
...
async function update_department_employment(req, res, next) {
    try {
...
async function hard_delete_department_employment(req, res, next) {
    try {
        const paramData = {
            id: parseInt(req.params.id),
        };
        if (isNaN(paramData.id)) {
            return res.status(400).json({ ...(0, handling_error_1.handling_error)(null, { message: "id bukan sebuah angka" }) });
        }
...
//ANCHOR - Mencari Bagian Jabatan
async function find_fixed_department_employment(req, res, next) {
    try {
        let getData = {
