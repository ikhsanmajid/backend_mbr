...
async function add_request(req, res, next) {
    try {
        let postData = {
        ...
        if ('data' in request) {
            const toAdminEmail = await (0, admin_users_service_1.get_admin_mail)();
...
//ANCHOR - Tambah Permintaan RB
async function edit_request(req, res, next) {
    try {
        let postData = {
            idCreated: res.locals.userinfo.id,
            idBagianCreated: res.locals.idBagian,
...
async function get_list_request(req, res, next) {
    try {
...
async function set_request_used(req, res, next) {
    try {
...
async function get_detail_request(req, res, next) {
    try {
        const id = req.params.id;
...
async function generate_report_dashboard_user(req, res, next) {
    try {
...
async function generate_report_serah_terima(req, res, next) {
    try {
