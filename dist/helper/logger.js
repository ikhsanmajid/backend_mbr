...
const logger = winston_1.default.createLogger({
    ...
    transports: [
        new winston_1.default.transports.File({ filename: 'backend/logs/error.log', level: 'error' }),
        new winston_1.default.transports.File({ filename: 'backend/logs/combined.log' }),
    ],
});
